...
static const int64_t multiAlgoNum = 3; // Amount of algos
static const int64_t multiAlgoTimespan = 20; // Time per block per algo
...
uint256 hashGenesisBlock("0x835db5516bda09fad931f83db836c8c0314c4d0facf0590df0bf95ea324005c6");
...
const string strMessageMagic = "Guptacoin Signed Message:\n";
...
{
	int64_t nSubsidy = 10 * COIN; // Default reward
	...
	// Pre-mine
	if (nHeight <= 150) // 1 - 150
		{
		nSubsidy = 10000000 * COIN;
		}

	// At this block there will be no more rewards
	if (nHeight > 50000150)
		{
		nSubsidy = 0 * COIN;
		}
